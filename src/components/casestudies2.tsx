    ...
    <section className="py-32">
      <div className="container">
        <div className="flex flex-col gap-6 text-center">
          <p className="font-medium font-mono">4500+ Satisfied Customers</p>
          <h2 className="text-4xl font-medium md:text-5xl font-sans">
          ...
          <div className="grid gap-16 lg:grid-cols-3 xl:gap-24">
            <div className="border-border flex flex-col gap-10 sm:flex-row lg:col-span-2 lg:border-r lg:pr-16 xl:pr-24">
              ...
              <div className="flex h-full flex-col justify-between gap-10">
                <q className="sm:text-xl font-sans">
            ...
            <div className="flex gap-10 self-center lg:flex-col">
              <div className="flex flex-col gap-2">
                <p className="text-primary text-4xl font-medium sm:text-5xl font-mono">
                  98%
                </p>
